...
changes in the physical features of a landscape. We recommend using the *USGS Landsat Surface Reflectance Tier 1* data sets.
...
Note that we provide a couple of shortcut functions to build annual surface reflectance collections and convert it to a collection formatted for use by LandTrendr. See the `buildSRcollection` and `buildLTcollection` functions in the [Shortcut Functions](./shortcut-functions.html#functions) section.
