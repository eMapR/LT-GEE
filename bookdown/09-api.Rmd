...
+ **visParams (dictionary)**:
    ...
    + **max (List of numbers)**: The gamma values for the three RGB bands 
...
This function is useful for generating high-quality time series frames for use in GIF movies. The following examples
applies the output to the Earth Engine `getVideoThumbURL` function.
